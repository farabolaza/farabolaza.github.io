...
BLOG_TITLE = "FEDE AR"  # (translatable)
...
THEME_CONFIG = {
    DEFAULT_LANG: {
        ...
        'sidebar': '',
        'navbar_light': False
        # Para que el tema sea clarito (estoy usando bg-primary y bg-dark)
    }
}
...
TAG_DESCRIPTIONS = {
   DEFAULT_LANG: {
       "bib": "Bibliografía de las materias que doy",
       "bib-matematica3": "Acá iría una descripción y html",
       "bib-matematica5": "Acá iría una descripción y html",
...
CATEGORY_TITLES = {
   DEFAULT_LANG: {
       ...
       "fisica4": "Física 4º",
       "fisicacontempo1": "Física contemporánea 1",
       "fisicacontempo2": "Física contemporánea 2",
       "energo": "Energotecnia",
       "electro": "Electrónica",
   },
}
...
FAVICONS = (
    ("icon", "/atom.png", "128x128"),
    ("icon", "/atom.ico", "128x128"),
)
